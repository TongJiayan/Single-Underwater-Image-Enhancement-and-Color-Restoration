...
if __name__ == '__main__':
    ...
    parser.add_argument('--image-folder', default='HE/OutputImages/UIEB', help='Images To Be Evaluated')
    parser.add_argument('--suffix', default='_HE.jpg', help='Suffix of Candidate Images Compared to Original Image Name')
    parser.add_argument('--score', default='MSE_HE.log', help='Write PSNR \t SSIM to This File')
