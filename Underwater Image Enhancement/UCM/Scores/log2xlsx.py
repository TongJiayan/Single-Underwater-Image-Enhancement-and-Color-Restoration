...
if __name__ == '__main__':
    ...
    parser.add_argument('--score-log', default='SQUID.log', help='score log')
    parser.add_argument('--original-result', default='pre_UCM_SQUID.xlsx', help='original result')
    parser.add_argument('--current-result', default='UCM_SQUID.xlsx', help='current result')
